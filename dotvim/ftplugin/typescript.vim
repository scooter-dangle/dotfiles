...
" Remap <buffer> keys for applying codeAction to the current buffer.
nmap <buffer> <leader>ac  <Plug>(coc-codeaction)
" Apply AutoFix to problem on the current line.
nmap <buffer> <leader>qf  <Plug>(coc-fix-current)

" Run the Code Lens action on the current line.
nmap <buffer> <leader>cl  <Plug>(coc-codelens-action)
...
nnoremap <buffer><silent><nowait> <space>a  :<C-u>CocList diagnostics<cr>
" Manage extensions.
nnoremap <buffer><silent><nowait> <space>e  :<C-u>CocList extensions<cr>
" Show commands.
nnoremap <buffer><silent><nowait> <space>c  :<C-u>CocList commands<cr>
" Find symbol of current document.
nnoremap <buffer><silent><nowait> <space>o  :<C-u>CocList outline<cr>
" Search workspace symbols.
nnoremap <buffer><silent><nowait> <space>s  :<C-u>CocList -I symbols<cr>
" Do default action for next item.
nnoremap <buffer><silent><nowait> <space>j  :<C-u>CocNext<CR>
" Do default action for previous item.
nnoremap <buffer><silent><nowait> <space>k  :<C-u>CocPrev<CR>
" Resume latest coc list.
nnoremap <buffer><silent><nowait> <space>p  :<C-u>CocListResume<CR>
